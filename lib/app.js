...
import { initResizeHandler, initTheme, initWidth, positionControls } from './theme.js'
...
function upsertMeta(m) {
  ...
  if (state.current === meta.id) {
    ...
    document.title = `${meta.title} · chat-agent`
...
async function openConversation(id, push, hash = '') {
  ...
  document.title = `${data.meta.title} · chat-agent`
