// theme + width state — single owner of the floating chat controls.
...
// <link>, sets the toggle glyph, sizes #chat-inner as a percentage of
// its container, and positions the floating #chat-controls pill.
...
// debounced 150 ms. Re-runs both layout effects (pill position and the
// column width re-apply) — nothing else may add a second listener.
let resizeTimer = 0
